...
def getLacci(msisdn):
    ...
    if(msisdn.strip() != ""):
        req = urllib2.Request("http://10.250.200.205:8001/?oprid=getInfo&msisdn=" + msisdn + "&show=json")
        ...
        if json['ResultCode'] == '0':
            newColumns = newColumns + "~" +json['longitude']+ "~" +json['latitude']
...
def toCSVLine(data):
    ...
    return rows + "~" + lacci_debit_credit + newColumns
